...
This is a documentation of de Novo assembly, annotation, and identification of 2 bacterial strains 11RA and 13R isolated from poplar trees. Geneious Prime is used for the assembly, KBase for quality determination, RAST for the annotation, and TYGS for identification. 
...
Two enophyte strains were submitted for sequencing and analysis. 

*De Novo* whole genome assemblies were completed on trimmed and normalized raw sequence reads with the Geneious Prime Assembler, and then submitted to RAST and TYGS for annotation and identification to the species level. Quality of assemblies were high, with >98% completeness, mean depth of coverage >= 50, and low contamination. The estimated genome size, gene count, and GC content were similar to other endophytic genomes of the same genus.

13R was identified to the species level (Azotobacter beijerinckii) while 11A was not. 

13R is deemed ready for characterization.
